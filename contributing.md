...
### v1.0
- [ ] more secret shit
- [ ] ~~maybe if the bot doesnt have a token specified itll just log shit to an output file~~ i forgot about the part where youd need the token specified anyways
